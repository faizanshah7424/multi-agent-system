...
class ToolDefinition(BaseModel):
    ...
    args_schema: Type[BaseModel] = Field(..., description="Pydantic validation schema class.")
    required_capabilities: List[str] = Field(default_factory=list, description="Capabilities required to use this tool.")
