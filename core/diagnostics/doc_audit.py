    ...
    def run_audit(self) -> Dict[str, Any]:
        ...
        for rel_path in self.required_files:
            ...
            if not file_path.exists():
                passed = False
                warnings.append(f"Missing core document: '{rel_path}' is not present at project root.")
        ...
        for folder_name in self.required_dir_docs:
            ...
            if folder_path.exists():
                ...
                if not readme_path.exists() and not md_files:
                    warnings.append(f"Directory warning: '{folder_name}' has no README.md or descriptive markdown docs.")
