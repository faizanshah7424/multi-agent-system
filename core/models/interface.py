from typing import Any, Dict, Iterator, Optional, Protocol, Type, TypeVar, runtime_checkable
...
class ModelParameters(BaseModel):
    ...
    response_format: Optional[Dict[str, Any]] = Field(None, description="Optional structural validation schema specification.")
    timeout: Optional[float] = Field(30.0, description="Timeout in seconds for LLM request.")
    retries: int = Field(3, description="Number of retry attempts on network/API failure.")
