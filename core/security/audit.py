...
class SecurityFinding(BaseModel):
    ...
    category: str = Field(..., description="Vulnerability type (e.g. SECRET_EXPOSURE, UNSAFE_SHELL, PATH_TRAVERSAL, UNSAFE_WRITE)")
...
class SecurityAuditEngine:
    ...
    def __init__(self) -> None:
        ...
        self.secret_patterns = [
            (r"(?i)(api_key|password|secret|auth_token)\s*[:=]\s*['\"][a-zA-Z0-9_\-]{16,}['\"]", "SECRET_EXPOSURE", "HIGH"),
            (r"AIzaSy[a-zA-Z0-9_\-]{33}", "SECRET_EXPOSURE", "CRITICAL"), # Google API key
        ...
        self.unsafe_py_calls = [
            ...
            (r"subprocess\.(Popen|run|call)\(.*shell\s*=\s*True", "UNSAFE_SUBPROCESS", "HIGH")
        ]

    def audit_code(self, code_content: str, file_path: str = "unknown") -> List[SecurityFinding]:
        """
        ...
        for idx, line in enumerate(lines, 1):
            ...
            if ".." in line and ("open(" in line or "Path(" in line or "os.path" in line):
                findings.append(SecurityFinding(
