...
class SymbolDefinition(BaseModel):
    ...
    symbol_type: Literal["class", "function", "module", "decorator"] = Field(..., description="Symbol classification.")
    ...
    imports: List[str] = Field(default_factory=list, description="Symbol-level import dependencies.")
